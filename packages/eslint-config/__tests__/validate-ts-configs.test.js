...
describe('Validate TS configs', () => {
  it('Validate eslint-config-luszz/typescript', async () => {
  ...
  it('Validate eslint-config-luszz/essential/typescript', async () => {
  ...
  it('Validate eslint-config-luszz/essential/typescript/react', async () => {
  ...
  // it('Validate eslint-config-luszz/typescript/node', async () => {
