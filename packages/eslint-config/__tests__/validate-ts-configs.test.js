...
describe('Validate TS configs', () => {
  it('Validate pure-eslint-config/typescript', async () => {
  ...
  it('Validate pure-eslint-config/typescript/vue', async () => {
  ...
  it('Validate pure-eslint-config/essential/typescript', async () => {
  ...
  it('Validate pure-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate pure-eslint-config/essential/typescript/vue', async () => {
