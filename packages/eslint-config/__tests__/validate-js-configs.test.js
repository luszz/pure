...
describe('Validate JS configs', () => {
  it('Validate pure-fe-eslint-config', async () => {
  ...
  it('Validate pure-fe-eslint-config/es5', async () => {
  ...
  it('Validate pure-fe-eslint-config/vue', async () => {
  ...
  it('Validate pure-fe-eslint-config/essential', async () => {
  ...
  it('Validate pure-fe-eslint-config/essential/es5', async () => {
  ...
  it('Validate pure-fe-eslint-config/essential/react', async () => {
  ...
  it('Validate pure-fe-eslint-config/essential/vue', async () => {
  ...
  it('Validate pure-fe-eslint-config/node', async () => {
