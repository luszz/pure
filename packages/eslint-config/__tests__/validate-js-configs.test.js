...
describe('Validate JS configs', () => {
  it('Validate eslint-config-luszz', async () => {
  ...
  it('Validate eslint-config-luszz/es5', async () => {
  ...
  it('Validate eslint-config-luszz/vue', async () => {
  ...
  it('Validate eslint-config-luszz/essential', async () => {
  ...
  it('Validate eslint-config-luszz/essential/es5', async () => {
  ...
  it('Validate eslint-config-luszz/essential/react', async () => {
  ...
  it('Validate eslint-config-luszz/essential/vue', async () => {
  ...
  it('Validate eslint-config-luszz/node', async () => {
