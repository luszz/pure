...
describe('Validate JS configs', () => {
  it('Validate pure-eslint-config', async () => {
  ...
  it('Validate pure-eslint-config/es5', async () => {
  ...
  it('Validate pure-eslint-config/vue', async () => {
  ...
  it('Validate pure-eslint-config/essential', async () => {
  ...
  it('Validate pure-eslint-config/essential/es5', async () => {
  ...
  it('Validate pure-eslint-config/essential/react', async () => {
  ...
  it('Validate pure-eslint-config/essential/vue', async () => {
  ...
  it('Validate pure-eslint-config/node', async () => {
